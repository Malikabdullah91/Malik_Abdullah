    ...
    <script>
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        loginButton.addEventListener("click", function (e) {
          ...
          if (username) {
            document.cookie = `username=${username}; expires=Sun, 12 May 2025 12:00:00 UTC; path=/`;
            // Ganti tanggal expires sesuai kebutuhan
            alert("Login successful!");
            window.location.href = "categories.php"; // Redirect ke halaman dashboard
          } else {
